...
print(dictku)   
# Output:
# {'nama': 'alice', 'usia': 25, 'alamat': 'jakarta'}

dictku['email'] = 'alice@gmail.com'
dictku['noid'] = 12345
print(dictku)   
# Output:
# {'nama': 'alice', 'usia': 25, 'alamat': 'jakarta', 'email': 'alice@gmail.com', 'noid': 12345}
...
print(dictku)  
# Output:
# {'nama': 'carl', 'usia': 25, 'alamat': 'bandung', 'email': 'carl@gmail.com'}
...
print(dictku)   
# Output:
# {'nama': 'alice', 'usia': 23, 'email': 'alice@gmail.com'}
